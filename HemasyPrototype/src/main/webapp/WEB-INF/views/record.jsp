	...
	<form action="recordCommit" method="post">
		<div id="food" class="mb-30 mt-20 bgc">
			...
			<div id="food_bre">
				...
				<c:forEach var="breakfastRecord" items="${breakfastRecordList}" varStatus="bStatus">
					<p class="breakfastData">
						<input type="text" value="${breakfastRecord.value1}" name="value1Bre${bStatus.index}">
			...
			<div id="food_lun">
				...
				<c:forEach var="lunchRecord" items="${lunchRecordList}" varStatus="lStatus">
					<p class="lunchData">
						<input type="text" value="${lunchRecord.value1}" name="value1Lun${lStatus.index}">
			...
			<div id="food_din">
				...
				<c:forEach var="dinnerRecord" items="${dinnerRecordList}" varStatus="dStatus">
					<p class="dinnerData">
						<input type="text" value="${dinnerRecord.value1}" name="value1Din${dStatus.index}">
			...
			<div id="food_sna">
				...
				<c:forEach var="snackRecord" items="${snackRecordList}" varStatus="sStatus">
					<p class="snackData">
						<input type="text" value="${snackRecord.value1}" name="value1Sna${sStatus.index}">
		...
		<div id="sport" class="mb-30 mt-20 bgc">
			...
			<c:forEach var="sportRecord" items="${sportRecordList}" varStatus="spStatus">
				<p class="sportData">
					<input type="text" value="${sportRecord.value1}" name="value1Spo${spStatus.index}">を
		...
		<div id="alcohol" class="mb-30 mt-20 bgc">
			...
			<c:forEach var="alcoholRecord" items="${alcoholRecordList}" varStatus="aStatus">
				<p class="alcoholData">
					<input type="text" value="${alcoholRecord.value1}" name="value1Alc${aStatus.index}">
