	...
	<form action="recordCommit">
			...
			<div id="food_bre">
				...
				<c:forEach var="breakfastRecord" items="${breakfastRecordList}">
					<p>
						...
						<input value="${breakfastRecord.value1}" name="value1">
						<input type="number" min="0" value="${breakfastRecord.value2}" name="value2" id="onceCal_${breakfastRecord.listsAndRecordsId}" onchange="calcCalorie(${breakfastRecord.listsAndRecordsId})">kcal ×
						<input type="number" min="0.1" step="0.1" value="${breakfastRecord.value3}" name="value3" id="amount_${breakfastRecord.listsAndRecordsId}" onchange="calcCalorie(${breakfastRecord.listsAndRecordsId})">人前＝
			...
			<div id="food_lun">
				...
				<c:forEach var="lunchRecord" items="${lunchRecordList}">
					<p>
						<input type="hidden" value="2" name="category">
						<input type="hidden" value="1" name="type">
						<input value="${lunchRecord.value1}" name="value1">
						<input type="number" min="0" value="${lunchRecord.value2}" name="value2" id="onceCal_${lunchRecord.listsAndRecordsId}" onchange="calcCalorie(${lunchRecord.listsAndRecordsId})">kcal ×
						<input type="number" min="0.1" step="0.1" value="${lunchRecord.value3}" name="value3" id="amount_${lunchRecord.listsAndRecordsId}" onchange="calcCalorie(${lunchRecord.listsAndRecordsId})">人前＝
						<span id="calorie_${lunchRecord.listsAndRecordsId}">${lunchRecord.value2 * lunchRecord.value3}</span>kcal
						<input type="hidden" value="2" name="value4">
						<input type="checkbox" value="${1}">簡易登録<a href="information.jsp">?</a>
					</p>
				</c:forEach>
			</div>
			<div id="food_din">
				...
				<c:forEach var="dinnerRecord" items="${dinnerRecordList}">
					<p>
						<input type="hidden" value="2" name="category">
						<input type="hidden" value="1" name="type">
						<input value="${dinnerRecord.value1}" name="value1">
						<input type="number" min="0" value="${dinnerRecord.value2}" name="value2" id="onceCal_${dinnerRecord.listsAndRecordsId}" onchange="calcCalorie(${dinnerRecord.listsAndRecordsId})"/>kcal ×
						<input type="number" min="0.1" step="0.1" value="${dinnerRecord.value3}" name="value3" id="amount_${dinnerRecord.listsAndRecordsId}" onchange="calcCalorie(${dinnerRecord.listsAndRecordsId})"/>人前＝
						<span id="calorie_${dinnerRecord.listsAndRecordsId}">${dinnerRecord.value2 * dinnerRecord.value3}</span>kcal
						<input type="hidden" value="3" name="value4">
						<input type="checkbox" value="${1}">簡易登録<a href="information.jsp">?</a>
					</p>
				</c:forEach>
			</div>
			<div id="food_sna">
				...
				<c:forEach var="snackRecord" items="${snackRecordList}">
					<p>
						<input type="hidden" value="2" name="category">
						<input type="hidden" value="1" name="type">
						<input value="${snackRecord.value1}" name="value1">
						<input type="number" min="0" value="${snackRecord.value2}" name="value2" id="onceCal_${snackRecord.listsAndRecordsId}" onchange="calcCalorie(${snackRecord.listsAndRecordsId})"/>kcal ×
						<input type="number" min="0.1" step="0.1" value="${snackRecord.value3}" name="value3" id="amount_${snackRecord.listsAndRecordsId}" onchange="calcCalorie(${snackRecord.listsAndRecordsId})"/>人前＝
						<span id="calorie_${snackRecord.listsAndRecordsId}">${snackRecord.value2 * snackRecord.value3}</span>kcal
						<input type="hidden" value="4" name="value4">
						<input type="checkbox" value="${1}">簡易登録<a href="information.jsp">?</a>
					</p>
				</c:forEach>
			</div>
		...
		<div id="sport">
			...
			<c:forEach var="sportRecord" items="${sportRecordList}">
				<p>
					...
					<input value="${sportRecord.value1}" name="value1">を
					<input type="hidden" value="${sportRecord.value2}" name="value2" id="mets_${sportRecord.listsAndRecordsId}">
					<input type="number" min="1" value="${sportRecord.value3}" name="value3" id="time_${sportRecord.listsAndRecordsId}" onchange="calcUsedCalorie(${sportRecord.listsAndRecordsId})"/>分運動しました。
		...
		<div id="smoke">
			...
			<p>
				...
				<input type="number" value="${smokeRecord.value3}" name="value3">本吸いました
			</p>
		</div>
		<div id="alcohol">
			...
			<c:forEach var="alcoholRecord" items="${alcoholRecordList}">
				<p>
					...
					<input value="${alcoholRecord.value1}" name="value1">
					<input type="number" min="0.1" value="${alcoholRecord.value4}" name="value4" id="oncePer_${alcoholRecord.listsAndRecordsId}" step="0.1">%
					<input type="number" min="0" value="${alcoholRecord.value5}" name="value5">kcal/杯
					<input type="number" min="1" value="${alcoholRecord.value2}" name="value2" id="onceAmount_${alcoholRecord.listsAndRecordsId}">ml/杯を
					<input type="number" min="0.1" step="0.1" value="${alcoholRecord.value3}" name="value3" id="amount_${alcoholRecord.listsAndRecordsId}">杯飲みました。
					<input type="checkbox" value="${1}">簡易登録<a href="information.jsp">?</a>
				</p>
			</c:forEach>
		</div>
		<div id="weight">
			...
			<p>
				...
				体重は<input type="number" min="1" value="${weightRecord.value2}" name="value2" id="weightRecord" step="0.1"/>kg、体脂肪率は<input type="number" min="0.1" value="${weightRecord.value3}" name="value3" step="0.1"/>%です。
			</p>
		</div>
