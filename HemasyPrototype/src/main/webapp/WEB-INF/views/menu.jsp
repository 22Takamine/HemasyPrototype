		...
		<div class="main-box">
			...
			<div class="button-box">
				<div class="record-button-box">
					<a href="/record" class="link button"><img
						src="../../images/record.png" alt="#" class="button-img"></a>
					<!-- ここaタグに変えたよ -->
				</div>
				<div class="statistics-button-box">
					<a href="/statistics" class="link button"><img
						src="../../images/statistic.png" alt="#" class="button-img"></a>
					<!-- ここaタグに変えたよ -->
				</div>
			</div>
