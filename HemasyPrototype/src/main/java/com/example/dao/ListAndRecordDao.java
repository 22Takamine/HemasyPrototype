...
public class ListAndRecordDao {
	...
	private static final String GET_LATEST_WEIGHT_RECORD2 = "SELECT * FROM lists_and_records WHERE category = 2 AND type = 5 AND user_id = :userId AND current_date >= create_date AND value2 <> '0' ORDER BY create_date DESC";
